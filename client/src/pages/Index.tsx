...
import cover1Image from '@assets/cover1_1760607783442_1760941143938.png';
import cover2Image from '@assets/cover2_1760607783442_1760941143941.png';
import cover3Image from '@assets/cover3_1760607783441_1760941143941.png';
      ...
      <div className="min-h-screen relative">
        ...
        <main className="relative z-10">
          ...
          <CoverSection
            ...
            alt="Ram & Eve Wedding Cover Image 1"
          />
          <ScrollTriggeredTimeline />
          <VenueSection />
          <CoverSection
            imageUrl={cover2Image}
            alt="Ram & Eve Wedding Cover Image 2"
          />
          <DressCodeSection />
          <HashtagGiftsSection />
          <RSVPSection />
          ...
          <CoverSection
            ...
            alt="Ram & Eve Wedding Cover Image 3"
          />
          <FAQSection />
          <Footer />
        </main>
