      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            >
              <div className="border border-border rounded-xl p-8 shadow-soft hover-elegant transition-all duration-500 h-full relative bg-white/80 dark:bg-gray-900/80">
