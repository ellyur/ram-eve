  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <div className="glass-peach border border-border rounded-xl p-12 shadow-soft hover-elegant">
            {/* RSVP Deadline */}
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">November 28, 2025</p>
            </div>
            ...
            {/* RSVP Button */}
            <a href="https://ram-eve-rsvp.replit.app" target="_blank" rel="noopener noreferrer">
              <button
